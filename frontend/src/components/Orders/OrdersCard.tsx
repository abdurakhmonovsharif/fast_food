            ...
            <div className="border-r-2 justify-center py-5 flex items-start gap-4">
                <div className="flex flex-col gap-[19px]">
                    <div className="bg-global_green  text-center text-white rounded-full py-[10px] w-24">
                        <span className="text-xl font-medium">8549</span>
                    </div>
                    <hr className="w-24" />
                    <div className="flex items-center w-24 justify-center gap-3">
                        <ClockIcon />
                        <span className="text-global_text_color text-xl">00:24</span>
                    </div>
                </div>
                ...
                <div className="flex flex-col gap-[23px] ">
                    <div className="space-y-2">
                        <div className="flex items-center justify-start gap-[12px] ">
                            ...
                            <p className="text-sm text-global_text_color">35,400 UZS</p>
                        </div>
                        <div className="flex items-center justify-start gap-[12px] ">
                            <div>
                                <TrackIcon />
                            </div>
                            <p className="text-sm text-global_text_color">5,000 UZS</p>
                        </div>
                    </div>
                    <div>
